...
<a href="https://github.com/Elixk/MY-VIBE-SKILLS">
...
<a href="https://github.com/Elixk/MY-VIBE-SKILLS/stargazers">
  <img src="https://img.shields.io/github/stars/Elixk/MY-VIBE-SKILLS?style=for-the-badge&logo=github&color=7B61FF&label=STARS" alt="stars">
</a>
<a href="https://github.com/Elixk/MY-VIBE-SKILLS/network/members">
  <img src="https://img.shields.io/github/forks/Elixk/MY-VIBE-SKILLS?style=for-the-badge&logo=git&color=45a1ff&label=FORKS" alt="forks">
</a>
<a href="https://github.com/Elixk/MY-VIBE-SKILLS/pulse">
  <img src="https://img.shields.io/github/last-commit/Elixk/MY-VIBE-SKILLS?style=for-the-badge&logo=git-lfs&color=32CD32&label=MOMENTUM" alt="last commit">
</a>
<a href="https://gitcgr.com/Elixk/MY-VIBE-SKILLS">
  <img src="https://gitcgr.com/badge/Elixk/MY-VIBE-SKILLS.svg" alt="gitcgr" />
</a>

<br/><br/>

<img src="https://komarev.com/ghpvc/?username=Elixk-MY-VIBE-SKILLS&label=NODES+ACTIVE&color=0078d7&style=for-the-badge" alt="Visitors">
&nbsp;
...
<a href="https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/install/one-click-install-release-copy.en.md">
  <img src="https://img.shields.io/badge/⚡_Get_Started-7B61FF?style=for-the-badge" alt="Install">
</a>
&nbsp;
<a href="https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/quick-start.en.md">
...
- [Recent Integrations](#-recent-integrations)
...
> **The expressway for academic productivity**: precise search across dozens of databases (PubMed, arXiv, etc.), systematic review matrix organization, citation management, the complete publication pipeline from drafting to peer review, and a repository-owned prompt asset layer for academic translation and writing workflows.

`arxiv-translator`, `bgpt-paper-search`, `biorxiv-database`, `brenda-database`, `chembl-database`, `citation-management`, `clinical-decision-support`, `clinical-reports`, `clinicaltrials-database`, `clinpgx-database`, `clinvar-database`, `comprehensive-research-agent`, `content-research-writer`, `cosmic-database`, `datacommons-client`, `documentation-lookup`, `drugbank-database`, `ena-database`, `ensembl-database`, `fda-database`, `geo-database`, `gwas-database`, `hmdb-database`, `hypothesis-generation`, `kegg-database`, `literature-matrix`, `literature-review`, `manuscript-as-code`, `market-research-reports`, `metabolomics-workbench-database`, `open-notebook`, `openalex-database`, `opentargets-database`, `paper-2-web`, `pdb-database`, `peer-review`, `prompt-library`, `pubchem-database`, `pubmed-database`, `pyzotero`, `reactome-database`, `research-grants`, `research-lookup`, `scholar-evaluation`, `scholarly-publishing`, `scientific-brainstorming`, `scientific-critical-thinking`, `scientific-reporting`, `scientific-writing`, `string-database`, `submission-checklist`, `uniprot-database`, `uspto-database`, `zinc-database`

Recent repo-owned additions in this area include the community-mirrored `arxiv-translator` workflow and the `prompt-library` asset surface, which currently carries 17 academic-writing prompts curated from `awesome-ai-research-writing`.
...
_VibeSkills is a living repository, not a frozen snapshot. Recent additions already normalized into this fork-ready base include:_

- **Community skill mirrors**: `ui-ux-pro-max`, `ai-search-hub`, `ssh-skill`, `pua`, and `arxiv-translator`
- **Academic paper translation workflow**: `arxiv-translator` adds arXiv e-print download, TeX inspection, translation-oriented workflow guidance, and PDF compilation support
- **Repository-owned prompt assets**: `prompt-library` is the first-party surface for keeping many prompts inside the repo without turning every prompt into a standalone skill
- **Seed prompt collection**: 17 academic-writing prompts from `awesome-ai-research-writing` are already normalized into `prompt-library` across `translation`, `writing`, `review`, and `research`

If you fork VibeSkills, the intended pattern is simple: mirror tool-like upstream repos as governed skills, and absorb prompt collections into `prompt-library`.
...
| | Single Public Entry |
|:---:|:---|
| **Install** | [⚡ Prompt-based install (recommended)](https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/install/one-click-install-release-copy.en.md) |
...
### Customize: Add your own skills and prompt assets

- [Custom workflow & skill onboarding guide](https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/install/custom-workflow-onboarding.en.md)
- [`prompt-library` README](./bundled/skills/prompt-library/README.md)
- [`skills管理和安装指南.md`](./skills管理和安装指南.md)

Use the onboarding guide when mirroring a full upstream skill repository. Use `prompt-library` when curating many prompts inside the repository under one governed asset surface.
...
- 📖 [System architecture & philosophy](https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/quick-start.en.md)
- 📜 [VibeSkills Manifesto](https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/manifesto.en.md)

**Installation & Configuration**

- ⚡️ [Prompt-based install (recommended)](https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/install/one-click-install-release-copy.en.md)
- 🧩 [Custom workflow onboarding](https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/install/custom-workflow-onboarding.en.md)
- 📄 [OpenClaw host notes](https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/install/openclaw-path.en.md)
- 📄 [OpenCode host notes](https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/install/opencode-path.en.md)
- 📁 [Manual copy install (offline)](https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/install/manual-copy-install.en.md)
- 🛠 [Advanced install command reference](https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/install/recommended-full-path.en.md)
- 🧊 [Cold start & other environments](https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/cold-start-install-paths.en.md)
...
## Star History
<div align="center">
<a href="https://www.star-history.com/?repos=Elixk%2FMY-VIBE-SKILLS&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/image?repos=Elixk/MY-VIBE-SKILLS&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/image?repos=Elixk/MY-VIBE-SKILLS&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/image?repos=Elixk/MY-VIBE-SKILLS&type=date&legend=top-left" />
 </picture>
</a>
...
<div align="center">
  ...
  <br/>
  <sub>Made with ❤️ &nbsp;·&nbsp; <a href="https://github.com/Elixk/MY-VIBE-SKILLS">GitHub</a> &nbsp;·&nbsp; <a href="./README.zh.md">中文</a></sub>
</div>
