...
| `Galaxy-Dawn/claude-scholar` | `MIT` | `claude-scholar` | `distributed-local` | Bundled/local distribution allowed with notice preservation |
...
- Distribution governance policy:
  [docs/distribution-governance.md](https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/distribution-governance.md)
- Upstream governance policy:
  [docs/governance/upstream-distribution-governance.md](https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/governance/upstream-distribution-governance.md)
- Provenance policy:
  [docs/governance/origin-provenance-policy.md](https://github.com/Elixk/MY-VIBE-SKILLS/blob/main/docs/governance/origin-provenance-policy.md)
