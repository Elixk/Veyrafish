...
# 添加项目路径到sys.path
sys.path.insert(0, '/Users/mayiding/Desktop/GitMy/Veyrafish')
...
def export_pdf(ir_file_path):
    ...
    try:
        ...
        output_dir = Path('/Users/mayiding/Desktop/GitMy/Veyrafish/final_reports/pdf')
...
if __name__ == "__main__":
    # 使用最新的报告文件
    latest_report = "/Users/mayiding/Desktop/GitMy/Veyrafish/final_reports/ir/report_ir_人工智能行情发展走势_20251119_235407.json"
