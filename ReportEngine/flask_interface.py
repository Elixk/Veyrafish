...
class ReportTask:
    ...
    def __init__(
        ...
        task_id: str,
        custom_template: str = "",
        evidence_task_ids: Optional[Any] = None,
    ):
        """
        ...
        self.evidence_task_ids = evidence_task_ids
...
def generate_report():
    ...
    try:
        ...
        evidence_task_ids = data.get('evidence_task_ids')
        ...
        task = ReportTask(query, task_id, custom_template, evidence_task_ids=evidence_task_ids)
        ...
        thread = threading.Thread(
            ...
            args=(task, query, custom_template, evidence_task_ids),
            daemon=True
        )
        thread.start()
    ...
    try:
        ...
        if not pango_available:
            return jsonify({
                ...
                'help_url': 'https://github.com/Elixk/Veyrafish/tree/beta',
