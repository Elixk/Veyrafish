...
class PlatformCrawler:
    ...
    def configure_mediacrawler_db(self):
        ...
        try:
            ...
            pg_password = config.settings.DB_PASSWORD if is_postgresql else "veyrafish"
            pg_user = config.settings.DB_USER if is_postgresql else "veyrafish"
            ...
            pg_db_name = config.settings.DB_NAME if is_postgresql else "veyrafish"
